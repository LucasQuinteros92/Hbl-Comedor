...
class Puerta(object):
    ...
    def __init__(self, pi, ClienteMqtt : MQTT.ClientMqtt, lcd1 : i2cDevice.Lcd):
    ...
    def __LeerEntradas(self):
        ...
        self.EstadoPuerta  = self.pi.read(vg.Pin_W2_WD0)
    ...
    def Actualizarlcd(self):
        ...
        self.lcd1.lcdWrite(1,espacios+str(self.CantidadDePersonas))
